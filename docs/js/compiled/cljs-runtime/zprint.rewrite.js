...
var G__74775 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(n) : rewrite_clj.zip.next.call(null,n));
loc = G__74775;
continue;
} else {
var G__74776 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__74776;
continue;
}
} else {
var G__74779 = (rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.next.cljs$core$IFn$_invoke$arity$1(loc) : rewrite_clj.zip.next.call(null,loc));
loc = G__74779;
continue;
}
}
...
var G__74755 = zloc;
var G__74756 = (function (){var G__74757 = zprint.rewrite.prewalk_subtree(p_QMARK_,f,(function (){var G__74758 = zloc;
var G__74758__$1 = (((G__74758 == null))?null:(rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.node.cljs$core$IFn$_invoke$arity$1(G__74758) : rewrite_clj.zip.node.call(null,G__74758)));
if((G__74758__$1 == null)){
return null;
} else {
return (zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1 ? zprint.zutil.edn_STAR_.cljs$core$IFn$_invoke$arity$1(G__74758__$1) : zprint.zutil.edn_STAR_.call(null,G__74758__$1));
}
})());
return (rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.root.cljs$core$IFn$_invoke$arity$1(G__74757) : rewrite_clj.zip.root.call(null,G__74757));
})();
return (rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.zip.replace.cljs$core$IFn$_invoke$arity$2(G__74755,G__74756) : rewrite_clj.zip.replace.call(null,G__74755,G__74756));
});
/**
...
var G__74781 = (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.down.call(null,nloc));
nloc = G__74781;
continue;
}
break;
...
var G__74784 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(nloc) : rewrite_clj.zip.right.call(null,nloc));
var G__74785 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(out,nloc);
nloc = G__74784;
out = G__74785;
continue;
} else {
...
var G__74789 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(replaced_loc) : rewrite_clj.zip.right.call(null,replaced_loc));
var G__74790 = cljs.core.next(new_loc);
var G__74791 = replaced_loc;
nloc = G__74789;
new_loc = G__74790;
last_loc = G__74791;
continue;
...
return zprint.rewrite.sort_val((function (){var G__74769 = (rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.right.cljs$core$IFn$_invoke$arity$1(zloc) : rewrite_clj.zip.right.call(null,zloc));
return (rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.down.cljs$core$IFn$_invoke$arity$1(G__74769) : rewrite_clj.zip.down.call(null,G__74769));
})());
});
/**
...
var new_dep = zprint.rewrite.prewalk(zloc,(function (p1__74770_SHARP_){
return ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.tag.cljs$core$IFn$_invoke$arity$1(p1__74770_SHARP_) : rewrite_clj.zip.tag.call(null,p1__74770_SHARP_)),new cljs.core.Keyword(null,"token","token",-1211463215))) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2((rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.zip.sexpr.cljs$core$IFn$_invoke$arity$1(p1__74770_SHARP_) : rewrite_clj.zip.sexpr.call(null,p1__74770_SHARP_)),new cljs.core.Keyword(null,"dependencies","dependencies",1108064605))));
