...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k45975,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k45975,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__45980){
var vec__45981 = p__45980;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45981,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45981,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__45974){
var self__ = this;
var G__45974__$1 = this;
return (new cljs.core.RecordIter((0),G__45974__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__45990 = (function (coll__4436__auto__){
return (580297420 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__45990(this__4435__auto____$1);
})();
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this45976,other45977){
var self__ = this;
var this45976__$1 = this;
return (((!((other45977 == null)))) && ((this45976__$1.constructor === other45977.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45976__$1.tag,other45977.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45976__$1.wrap_fn,other45977.wrap_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45976__$1.wrap_length,other45977.wrap_length)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45976__$1.seq_fn,other45977.seq_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45976__$1.children,other45977.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this45976__$1.__extmap,other45977.__extmap)));
}));
...
var self__ = this;
var this$__$1 = this;
var G__45996 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__45996) : self__.seq_fn.call(null,G__45996));
}));
...
var self__ = this;
var this$__$1 = this;
var G__45997 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__45997) : self__.wrap_fn.call(null,G__45997));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__45974){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__45998 = cljs.core.keyword_identical_QMARK_;
var expr__45999 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__46001 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
var G__46002 = expr__45999;
return (pred__45998.cljs$core$IFn$_invoke$arity$2 ? pred__45998.cljs$core$IFn$_invoke$arity$2(G__46001,G__46002) : pred__45998.call(null,G__46001,G__46002));
})())){
return (new rewrite_clj.node.seq.SeqNode(G__45974,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__46008 = new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130);
var G__46009 = expr__45999;
return (pred__45998.cljs$core$IFn$_invoke$arity$2 ? pred__45998.cljs$core$IFn$_invoke$arity$2(G__46008,G__46009) : pred__45998.call(null,G__46008,G__46009));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__45974,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__46012 = new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519);
var G__46013 = expr__45999;
return (pred__45998.cljs$core$IFn$_invoke$arity$2 ? pred__45998.cljs$core$IFn$_invoke$arity$2(G__46012,G__46013) : pred__45998.call(null,G__46012,G__46013));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__45974,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__46014 = new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231);
var G__46015 = expr__45999;
return (pred__45998.cljs$core$IFn$_invoke$arity$2 ? pred__45998.cljs$core$IFn$_invoke$arity$2(G__46014,G__46015) : pred__45998.call(null,G__46014,G__46015));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__45974,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__46016 = new cljs.core.Keyword(null,"children","children",-940561982);
var G__46017 = expr__45999;
return (pred__45998.cljs$core$IFn$_invoke$arity$2 ? pred__45998.cljs$core$IFn$_invoke$arity$2(G__46016,G__46017) : pred__45998.call(null,G__46016,G__46017));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__45974,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__45974),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__45974){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__45974,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__45978){
var extmap__4478__auto__ = (function (){var G__46021 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__45978,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__45978)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__46021);
} else {
return G__46021;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__45978),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__45978),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__45978),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__45978),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__45978),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__46022_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__46022_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__46024_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__46024_SHARP_);
}),children);
});
