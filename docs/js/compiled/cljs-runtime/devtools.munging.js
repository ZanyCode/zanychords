...
var o__40278__auto__ = f;
return (o__40278__auto__["toString"]).call(o__40278__auto__);
} else {
return "";
}
}catch (e42792){var _ = e42792;
return "";
}});
...
try{var o__40278__auto___43069 = t;
(o__40278__auto___43069["cljs$lang$ctorPrWriter"]).call(o__40278__auto___43069,t,writer);
}catch (e42800){var __43070 = e42800;
}
...
var char_code = (function (){var o__40278__auto__ = (new String(char$));
return (o__40278__auto__["charCodeAt"]).call(o__40278__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__40278__auto__ = String;
return (o__40278__auto__["fromCharCode"]).call(o__40278__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42831 = num_code;
switch (G__42831) {
case (1):
return (185);
...
var o__40278__auto__ = String;
return (o__40278__auto__["fromCharCode"]).call(o__40278__auto__,superscript_code);
});
/**
...
}catch (e42834){var _e__40285__auto__ = e42834;
return false;
}})())){
...
var vec__42835 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42835,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o42845 = temp__5733__auto__;
var temp__5733__auto____$1 = (o42845["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o42846 = temp__5733__auto____$1;
return (o42846["nameToPath"]);
} else {
return null;
}
} else {
...
var G__43074 = (i__4790__auto___43073 + (1));
i__4790__auto___43073 = G__43074;
continue;
} else {
}
break;
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42866){
var vec__42867 = p__42866;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42867,(0),null);
...
var G__43076 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__43077 = cljs.core.butlast(remaining_tokens);
name_tokens = G__43076;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42859){
...
var vec__42872 = cljs.core.split_with((function (p1__42871_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__42871_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42872,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42872,(1),null);
...
var vec__42878 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42878,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42878,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__43086 = cljs.core.rest(remaining_tokens);
var G__43087 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__43086;
name_tokens = G__43087;
continue;
} else {
...
var vec__42886 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42886,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42886,(1),null);
var vec__42889 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42889,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42889,(1),null);
var vec__42892 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42892,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42892,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42892,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42892,(3),null);
...
var vec__42902 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42902,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42902,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42902,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42902,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42902,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42902,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__42905 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42905,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42905,(1),null);
var vec__42908 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42908,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42908,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__42911 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__42911) : devtools.munging.parse_fn_info_deep.call(null,G__42911));
})()));
}
} else {
return fn_info;
...
var G__43106 = (arity + (1));
var G__43107 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42919){
var vec__42921 = p__42919;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42921,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42921,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42933_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__42933_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42934_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__42934_SHARP_);
}),sorted_infos);
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42942){
var vec__42944 = p__42942;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42944,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq42939){
var G__42940 = cljs.core.first(seq42939);
var seq42939__$1 = cljs.core.next(seq42939);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42940,seq42939__$1);
}));
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42962__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42962__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42962__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42962__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42963 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42963,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42963,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42963,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42963,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42963,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42963,(5),null);
...
var o__40278__auto__ = f;
return (o__40278__auto__["getBasis"]).call(o__40278__auto__);
});
/**
...
}catch (e42988){var _e__40285__auto__ = e42988;
...
var G__43156 = (obj[cljs.core.first(path)]);
var G__43157 = cljs.core.rest(path);
obj = G__43156;
path = G__43157;
continue;
} else {
...
var _STAR_ = (function (accum,p__43055){
var vec__43056 = p__43055;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43056,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43056,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__43059){
var vec__43060 = p__43059;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43060,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43060,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43060,(2),null);
...
var post_process = (function (p__43065){
var vec__43066 = p__43065;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43066,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43066,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43064_SHARP_){
return (obj[cljs.core.first(p1__43064_SHARP_)]);
}),sorted_matches);
