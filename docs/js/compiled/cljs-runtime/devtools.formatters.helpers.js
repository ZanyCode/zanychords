...
var G__69323 = devtools.prefs.pref(v);
v = G__69323;
continue;
} else {
return v;
...
}catch (e69225){var _e__38179__auto__ = e69225;
return false;
}})();
...
}catch (e69230){var _e__38179__auto__ = e69230;
return false;
}})();
...
}catch (e69232){var _e__38179__auto__ = e69232;
return false;
}}
}
});
...
var vec__69248 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69248,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__69248,(1),null);
...
return cljs.core.some((function (p1__69262_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__69262_SHARP_);
}),template);
});
