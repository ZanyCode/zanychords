...
var G__43125 = devtools.prefs.pref(v);
v = G__43125;
continue;
} else {
return v;
...
}catch (e43079){var _e__40285__auto__ = e43079;
return false;
}})();
...
}catch (e43084){var _e__40285__auto__ = e43084;
return false;
}})();
...
}catch (e43088){var _e__40285__auto__ = e43088;
return false;
}}
}
});
...
var vec__43098 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43098,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43098,(1),null);
...
return cljs.core.some((function (p1__43101_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__43101_SHARP_);
}),template);
});
