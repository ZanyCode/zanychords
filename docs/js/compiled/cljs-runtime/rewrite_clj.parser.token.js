...
return rewrite_clj.reader.read_until(reader,(function (p1__74218_SHARP_){
return ((cljs.core.not((allowed_QMARK_.cljs$core$IFn$_invoke$arity$1 ? allowed_QMARK_.cljs$core$IFn$_invoke$arity$1(p1__74218_SHARP_) : allowed_QMARK_.call(null,p1__74218_SHARP_)))) && (rewrite_clj.reader.whitespace_or_boundary_QMARK_(p1__74218_SHARP_)));
}));
});
...
var G__74223 = (rewrite_clj.reader.read_string.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.reader.read_string.cljs$core$IFn$_invoke$arity$1(s) : rewrite_clj.reader.read_string.call(null,s));
var G__74224 = s;
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__74223,G__74224) : rewrite_clj.node.token_node.call(null,G__74223,G__74224));
}
});
/**
